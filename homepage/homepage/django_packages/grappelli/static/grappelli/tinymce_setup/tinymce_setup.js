...
tinyMCE.init({
    ...
    plugins : "autolink,lists,spellchecker,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,grappelli,syntaxhl",
    // directionality : "rtl",
    ...
    theme_advanced_buttons2: 'search,|,pasteword,template,media,charmap,|,code,pagebreak,syntaxhl,|,table,cleanup,grappelli_documentstructure',
